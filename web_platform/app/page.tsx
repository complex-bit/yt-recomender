...
export default function Page() {
  ...
  const handleSkipLogin = () => {
    // Go directly to explore page without authentication
      ...
      <div className="relative z-10 text-center px-4">
        ...
        <div className="flex flex-col gap-4 items-center">
          <Button
            ...
            className="bg-white hover:bg-gray-50 text-[#3E2723] rounded-full px-12 py-8 text-xl font-bold shadow-xl hover:shadow-2xl transition-all hover:-translate-y-1 flex items-center gap-4 border-2 border-[#E0E0E0]"
          >
            Sign in with Google
          ...
          <Button
            ...
            variant="ghost"
            className="text-[#6B5B55] hover:text-[#3E2723] px-8 py-2 text-lg"
          >
